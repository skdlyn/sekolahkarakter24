    ...
    <section id="contact-page" class="contact-page">
        <div class="container" data-aos="fade-up">
            ...
            <div class="form col-lg-12">
                <header class="section-header">
                    <p style="font-size: 45px">INGIN MENGAJUKAN <span class="cus">KONSULTASI DENGAN KAMI ?</span></p>
                    <h2 style="margin-top: 15px;">Kami siap memberikan yang terbaik bagi anak dari Ayah Bunda. Apabila ada
